...
<head>
    ...
    <title>SMÜZN + DAVID SONNY MIHAESCU</title>
...
<body>
        ...
        <section class="pages">
            <section class="section1" id="section1">
                <section class="sub-section1" id="sub-section1">
                    <section class="box1">
                        <img src="https://www.smuzn.xyz/.images/JPG/artists/davidmihaescu.jpg" alt="plus" class="image1">
    ...
    <!--                    <section class="menu-box1"><button class="menu">menu<br><section class="menu-sub2-box1"> smuzn</section></button></section>-->
                        <div class="sub1-box1">
                            <p class="text1"><img src="https://www.smuzn.xyz/.images/SVG/piu.svg" alt="plus" class="plus plus-g-design">GRAPHIC DESIGNER</p>
                        </div>
                        <div class="sub2-box1">
                            <p class="text2">DAVID SONNY<br>MIHAESCU<img src="https://www.smuzn.xyz/.images/SVG/piu.svg" alt="plus" class="plus plus-david"></p>
                        </div>
                    </section>
                </section>
            </section>
